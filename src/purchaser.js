...
function handleInputChange3(event) {
  ...
  const Purchase = async () => {
    ...
    var contractaddress = '0xbBF386C2F6c7F78d2879C3d453816E5683e489c1';
    ...
    var contractaddress_token = '0xcF1C3457bFdc0dFa067cF97234015C00DaC7d73f';
      ...
      <div className="row">
        <div className="">
          <div className="card no-hover staking-card single-staking">
            <h3 className="m-0">Reward Point </h3>
